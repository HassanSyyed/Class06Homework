...
export default function SuzukiAltoDes() {
    return (
        <div>
            <div className="bg-white">
                <h1 className="text-3xl font-bold text-blue-800 text-center  pt-4">Suzuki Alto Price in Pakistan 2024, Images, Reviews & Specs</h1>
            </div>
                ...
                <div className="bg-white">
                    ...
                    <div className="bg-white px-20 py-2 w-full gap-4 flex flex-col justify-center">
                        <div className="bg-white px-20 py-1 w-full gap-10 flex flex-row justify-start">
                            ...
                            <h1 className="font-semibold">Engine: 658 CC </h1>
                            <h1 className="font-semibold">Condition: 100%</h1>
                        </div>
                        <div className="bg-white px-20 py-1 w-full gap-10 flex flex-row justify-center">
                            <h1 className="font-semibold">Driven: 52,000 KM </h1>
                            <h1 className="font-semibold">Suspension Type: Soft</h1>
                            <h1 className="font-semibold">Avg: 18-20 Km Per Ltr</h1>
                            <h1 className="font-semibold">Transmission: Automatic</h1>
                        </div>
                    </div>
                    <h2 className="text-green-500 py-1 text-center text-2xl font-semibold"> PKR 23.3 lacs</h2>
                </div>
                <div className="py-3">
                    <Link href="/Featured">
